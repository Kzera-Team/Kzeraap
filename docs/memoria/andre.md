...
Arquivo de registro pessoal do papel **andre**.
...
- **Prática adotada:** criar este arquivo `docs/memoria/andre.md` no Kzera como cápsula provisória de memória até existir feature própria no Chatzera.
