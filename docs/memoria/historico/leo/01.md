<!-- ARQUIVO DE HISTÓRICO DE MEMÓRIA — leo — volume 01 -->
<!-- Criado em 2026-07-09 por pedido do líder (repassado por Max, Tech Lead), seguindo o mesmo padrão já aplicado a docs/memoria/max.md e docs/memoria/bruno.md em 2026-07-06, para reduzir consumo de tokens sem perder informação. -->
<!-- Conteúdo abaixo: cópia ÍNTEGRA e literal de docs/memoria/leo.md como estava em 2026-07-09 (88 linhas, 4 entradas, todas de 2026-07-04), nenhuma linha removida ou alterada. -->
