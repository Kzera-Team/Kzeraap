# Métricas locais de UX 1.19.2

## Objetivo

A versão 1.19.2 implementa métricas locais de uso e fluxo para melhorar a experiência da Usuária. O sistema mede apenas sinais genéricos de navegação e conclusão de fluxo.
...
Os eventos de tempo parado, atrito automático e interação por campo foram removidos da 1.19.2 e não devem existir no código desta versão. Eles só podem voltar em versão futura, se forem aprovados novamente.
