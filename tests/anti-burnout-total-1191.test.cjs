...
const screenMatrix = [
  ...
  ['Perfis lista', 'src/presentation/perfil/templates/PerfilTemplate.html', ['Sem pressa: busque ou crie um perfil.', 'Procure primeiro. Cadastre só se não encontrar.', 'Mostrando 80 perfis para proteger o iPhone.']],
  ['Perfil cadastro', 'src/presentation/perfil/templates/PerfilTemplate.html', ['Novo perfil', 'Nome obrigatório', 'Conheço pessoalmente']],
  ['Perfil resumo/histórico/duplicidades', 'src/presentation/perfil/templates/PerfilTemplate.html', ['Resumo dos perfis', 'Histórico', 'Duplicidades']],
