...
if (relevant.length === 0) {
  console.log('Test Evidence Guard: nenhuma alteracao funcional/UI exige evidencia real.');
  process.exit(0);
}
...
if (evidences.length === 0) {
  console.error('Test Evidence Guard: alteracoes em app/UI/public exigem evidencia real em .test-evidence/*.md');
...
if (!ok) {
  console.error('Test Evidence Guard: evidencia encontrada, mas incompleta.');
...
console.log('Test Evidence Guard: evidencia real obrigatoria encontrada.');
