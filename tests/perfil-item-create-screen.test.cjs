...
const perfilTemplate = fs.readFileSync('src/presentation/perfil/templates/PerfilTemplate.html', 'utf8');
...
assert(perfilView.includes('bindCreateScreen('), 'View de Perfis deve alternar listagem/cadastro.');
